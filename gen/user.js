...
function expandLine(line, expandNum)
{
	var tokens = line.split("\t");
	if(tokens.length != 3) {
		console.error("error when expand:", line);
		return;
	}

	for(var i=0; i<expandNum; i++)
	{
		console.log(lastNames[i]+tokens[0], tokens[1]+(1001+i), tokens[2]);
	}
}

var userFile = process.argv[2]
var lineExpand = process.argv[3];

var fs = require("fs");
var content = fs.readFileSync(userFile, "utf8");
var lines = content.split("\n");

for(var i=0; i<lines.length; i++)
{
	expandLine(lines[i], lineExpand);
}
