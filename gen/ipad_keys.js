...
<option value="R502">Apple Store, MixC Chengdu</option>
*/

var skus = new Array("MD528CH/A", "MD531CH/A");
...
function generate() {
	...
	for(var i=0; i<lines.length; i++)
	{
		...
		var payload = cart.governmentID + ',' + locale
				...
				+ cart.planType;
		if(i==0) {
			console.error("123456789876543456,zh_CN,R390,MD528CH/A,2,新利,陈,chen.daqi@yahoo.cn,undefined,iPad,undefined");
